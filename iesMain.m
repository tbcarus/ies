...
inputFileName = 'input-bell.xlsx'; % имя входного файла с данными
...
for i = 1:len 
    ...
    %сделано так для корректного достраивания КСС, которые заданы не в
    %азимутильных углах 0-360 градусов. Это место для оптимизации, но по
